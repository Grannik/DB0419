...
ctx.beginPath();//Начало рисования
    ...
    ctx.fillText("fünf Minuten nach...",580,90);
    ctx.fillText("zehn Minuten nach...",0,0);
    ctx.fillText("Viertel nach...",0,0);
    ctx.fillText("zwanzig Minuten nach...",0,0);
    ctx.fillText("fünf vor halb",0,0);
    ctx.fillText("halb...",0,0);
    ctx.fillText("fünf nach halb",0,0);
    ctx.fillText("zwanzig Minuten vor...",0,0);
    ctx.fillText("Viertel vor...",0,0);
    ctx.fillText("drei Viertel",0,0);
    ctx.fillText("zehn Minuten vor...",0,0);
    ctx.fillText("fünf Minuten vor...",0,0);
    ctx.fillText("Kurz nach...",0,0);
    ctx.fillText("Kurz vor...",0,0);
    ctx.fillText("Kurz vor halb...",0,0);
    ctx.fillText("Kurz nach halb...",0,0);
